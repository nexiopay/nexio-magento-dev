 ...
 * @link      https://nex.io
 */
class RequireCvc extends \Magento\Config\Block\System\Config\Form\Field
{

    /**
     * Constant varriable for require cvc
     */
    const CONFIG_PATH = 'onlinepayment/processingoptions/require_cvc';
     ...
     * Get the require cvc
     *
     * @return Require cvc from config
     */
