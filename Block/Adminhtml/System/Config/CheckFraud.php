 ...
 * @link      https://nex.io
 */
class CheckFraud extends \Magento\Config\Block\System\Config\Form\Field
{

    /**
     * Constant varriable for check fraud
     */
    const CONFIG_PATH = 'onlinepayment/processingoptions/checkFraud';
     ...
     * Get the check fraud
     *
     * @return Check fraud from config
     */
